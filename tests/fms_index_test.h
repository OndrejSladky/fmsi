...
namespace {
    fms_index get_dummy_index() {
        fms_index ret = { //CAGGTAG$, 1011100$
                ...
                sdsl::rank_support_v5<1>(),
                sdsl::rrr_vector<RRR_BLOCK_SIZE>({0, 0, 0, 1, 0, 1, 1, 1}),
                sdsl::rank_support_rrr<1, RRR_BLOCK_SIZE>(),
    ...
    fms_index get_dummy_index2() {
        fms_index ret = { //GGTAAGA$, 11001000$
                ...
                sdsl::rank_support_v5<1>(),
                sdsl::rrr_vector<RRR_BLOCK_SIZE>({0,0,1,0,0,1,1,0,0}),
                sdsl::rank_support_rrr<1, RRR_BLOCK_SIZE>(),
    ...
    fms_index get_dummy_index3() {
        fms_index ret = { // CACACAT$, 1110100$
                ...
                sdsl::bit_vector({1}),
                sdsl::rank_support_v5<1>(),
                sdsl::rrr_vector<RRR_BLOCK_SIZE>({0,1,0,0,1,1,1,0}),
                sdsl::rank_support_rrr<1, RRR_BLOCK_SIZE>(),
