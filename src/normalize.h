...
void count_k_mers(camel::kh_S64_t *k_mers, std::string superstring, mask_t mask, int k, assignable_function_t f) {
...
masked_superstring_t normalize(std::string superstring, mask_t mask, int k, assignable_function_t f) {
